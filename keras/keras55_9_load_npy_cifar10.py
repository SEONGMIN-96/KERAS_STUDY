...
x_train = np.load(filepath+'k55_x_train_cifar10.npy')
y_train = np.load(filepath+'k55_y_train_cifar10.npy')
x_test = np.load(filepath+'k55_x_test_cifar10.npy')
y_test = np.load(filepath+'k55_y_test_cifar10.npy')
