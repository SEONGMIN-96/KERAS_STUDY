...
augment_size = 40000        # 추가할 데이터의 수를 맞춰준다.
...
# 6만개의 데이터중 무작위로 4만개의 데이터를 뽑기 위한 과정
...
# (100000, 28, 28, 1) (100000,) 10만개의 데이터 생성
...
데이터 10만개
val_loss : 0.20356059074401855
val_acc : 0.9902999997138977
