...
from tensorflow.keras.layers import Dense, Conv2D, MaxPool2D, Flatten, Dropout, GlobalAveragePooling2D, LSTM, MaxPooling1D, MaxPool1D

model = Sequential()
model.add(LSTM(64, input_shape=(32, 32 * 3), activation='relu'))
...
hist = model.fit(x_train, y_train, epochs=100, batch_size=258, verbose=1, callbacks=es,
