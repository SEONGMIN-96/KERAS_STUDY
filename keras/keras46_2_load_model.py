...
# model = load_model('./_save/keras46_1_save_model_1.h5') # Total params: 29,441
model = load_model('./_save/keras46_1_save_model_2.h5') # Total params: 29,441
...
# model.fit(x_train, y_train, epochs=20, batch_size=8, shuffle=False, verbose=1)
...
epochs = 20, load_model

loss :  5582.20263671875
mae :  65.11690521240234
소요 시간 :  21.93646240234375

epochs = 20, include

loss :  5936.3408203125
mae :  66.81400299072266
소요 시간 :  21.584200143814087
