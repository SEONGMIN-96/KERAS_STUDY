...
reduce_lr = ReduceLROnPlateau(monitor='val_loss', mode='auto', patience=10, factor=0.4)
es = EarlyStopping(monitor='val_loss', mode='min', patience=10,)

model.compile(loss='mse', optimizer=optimizer, metrics='mae')
model.fit(x_train, y_train, epochs=300, validation_split=0.2, batch_size=8, shuffle=False, verbose=2, callbacks=[es, reduce_lr])
